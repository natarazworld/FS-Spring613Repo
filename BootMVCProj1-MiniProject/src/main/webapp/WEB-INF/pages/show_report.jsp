              ...
              <tr> 
               ...
               <c:forEach var="emp" items="${empsInfo}">
                 <tr>
                   ...
                   <td>${emp.sal} </td>
                   <td>     
                       <a href="edit?no=${emp.empno}"><img src="images/edit.png" width="30" height="30"></a>
                        <a href="delete?no=${emp.empno}" onclick="return confirm('Do want to delete?')"><img src="images/delete.jpg" width="30" height="30"></a>
                   </td>
                 </tr>
               </c:forEach>
         </table>
