...
public class StudentMgmtServiceImpl implements IStudentMgmtService {
	//HAS-A property
	@Autowired
	//@Qualifier("oraStudDAO") // bad becoz of bean id hardcoded
	//@Qualifier("${dao.choose}")  //bad becoz @Qualifier does not recongize place holder
	//@Qualifier(@Value("${dao.choose}")) ////bad becoz @Qualifier does not recongize @Value annoation
	@Qualifier("dao")
